...
export default function Logo({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid place-items-center rounded-xl glow-blue",
        className,
      )}
    ...
    >
      ...
      >
        <svg viewBox="0 0 64 64" className="w-full h-full">
          ...
          {/* Shield */}
          <path
            d="M32 4l18 6v14c0 13.5-9.3 24.3-18 28-8.7-3.7-18-14.5-18-28V10l18-6z"
            fill="url(#g1)"
            opacity="0.3"
          />
          <path
            d="M32 6l16 5v13c0 12.8-8.6 22.8-16 26.2C24.6 46.8 16 36.8 16 24V11l16-5z"
            stroke="url(#g1)"
            strokeWidth="2"
            fill="none"
          />
          {/* Wave */}
          <path
            d="M12 34c6-4 12-4 18 0s12 4 18 0"
            stroke="url(#g2)"
            strokeWidth="3"
            fill="none"
          >
